...
const FeatureCard = ({ icon: Icon, title, description, isNew = false }) => {
  return (
              ...
              >
                ...
                <motion.div variants={itemVariants}>
                  <FeatureCard
                    ...
                    description="Bank-level encryption and privacy controls ensure your company data and conversations remain secure."
                  />
                </motion.div>
              ...
              >
                ...
                <motion.div variants={itemVariants}>
                  <FeatureCard
                    ...
                    description="Control who can access which AI executives and what company information they can view."
                  />
                </motion.div>
