...
interface SelectedPerson {
  id?: string | number; // Assuming an ID might exist
  name: string;
  position: string;
  image?: string; // Optional image
}

// Define prop types for ChatTopBar
interface ChatTopBarProps {
  selectedPerson: SelectedPerson | null;
  onClearHistory: () => void;
}

export default function ChatTopBar({ selectedPerson, onClearHistory }: ChatTopBarProps) { // Apply props type
